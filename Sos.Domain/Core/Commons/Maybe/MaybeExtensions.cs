namespace Sos.Domain.Core.Commons.Maybe
{
    /// <summary>
    ...
    public static class MaybeExtensions
    {
        ...
        /// <returns>
        /// The success result with the bound value if the current result is a success result, 
        /// otherwise a failure result.
        /// </returns>
        public static async Task<Maybe<TOut>> Bind<TIn, TOut>
        (
            this Maybe<TIn> maybe, Func<TIn,
            Task<Maybe<TOut>>> func
        ...
        /// <returns>
        /// The result of the on-success function if the maybe has a value, 
